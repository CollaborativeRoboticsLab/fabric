...
public:
  ...
  int add_parallel_all(std::map<int, capabilities2::node_t>& connections, int connection_id = 0, std::string description = "")
  {
    ...
    node.source.runner = "capabilities2_capabilities/InputMultiplexAllRunner";
    node.source.provider = "capabilities2_capabilities/InputMultiplexAllRunner";
  ...
  int add_parallel_any(std::map<int, capabilities2::node_t>& connections, int connection_id = 0, std::string description = "")
  {
    ...
    node.source.runner = "capabilities2_capabilities/InputMultiplexAnyRunner";
    node.source.provider = "capabilities2_capabilities/InputMultiplexAnyRunner";
    node.source.parameters = this->system_runner_xml(node.source.runner, node.source.provider, input_count, runner_index);
  ...
  void check_and_update_runner_id(capabilities2::node_t& predecessor, capabilities2::node_t& successor)
  {
    ...
    if (predecessor.source.runner.find("capabilities2_capabilities/InputMultiplexAnyRunner") != std::string::npos ||
        predecessor.source.runner.find("capabilities2_capabilities/InputMultiplexAllRunner") != std::string::npos)
    {
